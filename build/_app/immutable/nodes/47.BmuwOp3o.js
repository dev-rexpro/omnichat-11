...
import { p as push, g as getContext, c as child, n as sibling, r as reset, z as untrack, t as template_effect, d as set_text, q as event, a as append, h as comment, i as first_child, l as get, k as set, u as derived_safe_equal, b as pop, e as store_get, s as setup_stores, m as mutable_source, f as from_html, o as onMount, v as onDestroy, w as legacy_pre_effect, y as legacy_pre_effect_reset, j as deferred_template_effect, $ as $document, B as tick, E as next, aW as mutate, D as text, x as deep_read_state } from "../chunks/CISwU846.js";
...
import { c as config, u as user, t as tools, W as WEBUI_NAME } from "../chunks/C2d9K3Bp.js";
import { g as goto } from "../chunks/A3V7pFI8.js";
import { l as loadToolByUrl, k as getToolList, g as getTools, c as createNewTool, m as deleteToolById, n as exportTools, a as getToolById } from "../chunks/1FYPZhvT.js";
...
var root_15 = from_html(`<div class=" w-full h-full flex flex-col justify-center items-center my-16 mb-24"><div class="max-w-md text-center"><div class=" text-3xl mb-3">😕</div> <div class=" text-lg font-medium mb-1"> </div> <div class=" text-gray-500 text-center text-xs"> </div></div></div>`);
var root_16 = from_html(`<div class=" my-16"><div class=" text-xl font-medium mb-1 line-clamp-1"> </div> <a class=" flex cursor-pointer items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-850 w-full mb-2 px-3.5 py-1.5 rounded-xl transition" href="https://omnichat.rexpro.com/tools" target="_blank"><div class=" self-center"><div class=" font-medium line-clamp-1"> </div> <div class=" text-sm line-clamp-1"> </div></div> <div><div><!></div></div></a></div>`);
