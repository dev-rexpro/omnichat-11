...
import { t as template_effect, a as append, F as from_svg, p as push, g as getContext, o as onMount, i as first_child, k as set, l as get, n as sibling, b as pop, s as setup_stores, m as mutable_source, u as derived_safe_equal, z as untrack, c as child, x as deep_read_state, r as reset, q as event, f as from_html, e as store_get, d as set_text, h as comment, D as text, A as user_derived, E as next, B as tick, w as legacy_pre_effect, y as legacy_pre_effect_reset, v as onDestroy, aW as mutate, j as deferred_template_effect, $ as $document } from "../chunks/CISwU846.js";
...
import { s as set_class, c as clsx, a as set_attribute, d as set_style, r as remove_input_defaults } from "../chunks/CpNYkTX2.js";
...
import { P as Pane_group, c as Pane, d as Pane_resizer } from "../chunks/CrKeSEL_.js";
import { g as goto } from "../chunks/A3V7pFI8.js";
import { u as user, b as settings, m as mobile, s as showSidebar, h as showArchivedChats, k as socket, g as chatId, o as channelId, i as channels } from "../chunks/C2d9K3Bp.js";
import { g as getMessageData, r as removeReaction, a as addReaction, p as pinMessage, u as updateMessage, d as deleteMessage, b as getChannelMembersById, c as addMembersById, e as removeMembersById, f as getChannelPinnedMessages, h as getChannelThreadMessages, s as sendMessage, i as getChannelById, j as getChannelMessages } from "../chunks/DrOJmvdE.js";
import { e as each, i as index } from "../chunks/D16NL_tt.js";
import { d as dayjs2, r as relativeTime } from "../chunks/OO7lCI-F.js";
import { J as isToday, K as isYesterday, r as formatDate, v as v4 } from "../chunks/7pK2BKln.js";
import { l as localizedFormat } from "../chunks/_xypnXqU.js";
import { b as WEBUI_API_BASE_URL } from "../chunks/Cjpn_aRT.js";
import { M as Markdown, I as Image } from "../chunks/CiZwScVd.js";
import { N as Name, P as ProfileImage } from "../chunks/BZV2Wl24.js";
...
import { F as FileItem, C as ChatBubble } from "../chunks/DeM0jLky.js";
import { P as ProfilePreview } from "../chunks/B8qMUhuw.js";
import { E as EmojiPicker, F as FaceSmile } from "../chunks/jP6frFRU.js";
import { C as ChevronRight } from "../chunks/B_BET3Ob.js";
import { E as Emoji } from "../chunks/C0OD75Y3.js";
import { S as Skeleton } from "../chunks/DIvZspYJ.js";
import { P as PinSlash, a as Pin } from "../chunks/CIfJ2FQs.js";
import { L as Loader } from "../chunks/CLJcSX52.js";
import { S as Spinner } from "../chunks/7N5LES1L.js";
import { M as MessageInput } from "../chunks/COIddrkQ.js";
import { U as UserMenu } from "../chunks/BcCOHtvP.js";
...
import { b as bind_value } from "../chunks/DhE2rCDJ.js";
import { P as Pagination_1 } from "../chunks/bnSfktVM.js";
import { B as Badge } from "../chunks/Yu2VL_J7.js";
...
import { D as Drawer } from "../chunks/CRXxh1L7.js";
import { i as i18n } from "../chunks/C6H2E58f.js";
        ...
        var consequent_11 = ($$anchor3) => {
          ...
          var node_21 = child(button_6);
          {
            ...
            var alternate_1 = ($$anchor4) => {
              ...
              template_effect(
                ($0) => {
                  set_attribute(img_1, "src", (deep_read_state(message()), deep_read_state(WEBUI_API_BASE_URL), untrack(() => {
                    var _a, _b, _c;
                    return ((_a = message().reply_to_message.user) == null ? void 0 : _a.role) === "webhook" ? `${WEBUI_API_BASE_URL}/channels/webhooks/${(_b = message().reply_to_message.user) == null ? void 0 : _b.id}/profile/image` : `${WEBUI_API_BASE_URL}/users/${(_c = message().reply_to_message.user) == null ? void 0 : _c.id}/profile/image`;
                  })));
        ...
        var consequent_14 = ($$anchor3) => {
          ...
          var node_24 = first_child(fragment_10);
          {
            ...
            var consequent_13 = ($$anchor4) => {
              {
                let $0 = derived_safe_equal(() => (deep_read_state(WEBUI_API_BASE_URL), deep_read_state(message()), untrack(() => {
                  var _a;
                  return `${WEBUI_API_BASE_URL}/channels/webhooks/${(_a = message().user) == null ? void 0 : _a.id}/profile/image`;
                })));
                ...
                children: ($$anchor5, $$slotProps) => {
                  {
                    let $0 = derived_safe_equal(() => (deep_read_state(WEBUI_API_BASE_URL), deep_read_state(message()), untrack(() => {
                      var _a;
                      return `${WEBUI_API_BASE_URL}/users/${(_a = message().user) == null ? void 0 : _a.id}/profile/image`;
                    })));
          ...
          each(
            ...
            ($$anchor4, file) => {
              const fileUrl = derived_safe_equal(() => (get(file), deep_read_state(WEBUI_API_BASE_URL), untrack(() => {
                var _a;
                return get(file).url.startsWith("data") || get(file).url.startsWith("http") ? get(file).url : `${WEBUI_API_BASE_URL}/files/${get(file).url}${((_a = get(file)) == null ? void 0 : _a.content_type) ? "/content" : ""}`;
              })));
              var div_19 = root_15();
      ...
      var node_19 = child(div_14);
      {
        ...
        UserMenu(node_19, {
          ...
          children: ($$anchor3, $$slotProps) => {
            ...
            reset(div_15);
            reset(button_3);
            template_effect(() => set_attribute(img_1, "src", (deep_read_state(WEBUI_API_BASE_URL), $user(), untrack(() => {
              var _a;
