...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS 必須由供應商正確設定，以允許來自 Omnichat 的請求。",
  ...
  "Discover how to use Omnichat and seek support from the community.": "探索如何使用 Omnichat 並從社群尋求支援。",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "您想要同步使用統計資料至 Omnichat 社群嗎？",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "由 Omnichat 社群製作",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "MCP 支援為實驗性功能，其規範經常變更，可能導致不相容問題。OpenAPI 規範支援直接由 Omnichat 團隊維護，是相容性更可靠的選擇。",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat 可使用任何 OpenAPI 伺服器提供的工具。",
  "Omnichat uses faster-whisper internally.": "Omnichat 使用內部 faster-whisper。",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat 使用 SpeechT5 和 CMU Arctic 說話者嵌入。",
  "Omnichat version": "Omnichat 版本",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Omnichat 版本 (v{{OPEN_WEBUI_VERSION}}) 低於所需版本 (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Omnichat. Your privacy is paramount: no message content is ever shared.": "參與社群排行榜和評估！同步聚合的使用統計資料有助於推動 Omnichat 的研究和改進。您的隱私至關重要：絕不會分享訊息內容。",
  Password,
  ...
  Record,
  "Record voice": "錄音",
  "Redirecting you to Omnichat Community": "正在將您重導向至 Omnichat 社群",
  ...
  "Share to Omnichat Community": "分享到 Omnichat 社群",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "您的所有貢獻將會直接交給外掛開發者；Omnichat 不會收取任何抽成。然而，所選擇的贊助平臺可能有其自身的費用。",
