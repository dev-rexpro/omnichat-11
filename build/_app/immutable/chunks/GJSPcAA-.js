...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS måste vara korrekt konfigurerad av leverantören för att tillåta förfrågningar från Omnichat.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Upptäck hur du använder Omnichat och sök stöd från communityn.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Vill du synkronisera din användningsstatistik med Omnichat Community?",
  Docling,
  ...
  "Enter the public URL of your WebUI. This URL will be used to generate links in the notifications.": "Ange den offentliga URL:en för din WebUI. Den här URL kommer att användas för att generera länkar i notifikationerna.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Skapad av OpenWebUI Community",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "MCP-stödet är experimentellt och dess specifikation ändras ofta, vilket kan leda till inkompatibilitet. OpenAPI-specifikationen underhålls direkt av Omnichat-teamet, vilket gör det till det mer tillförlitliga alternativet för kompatibilitet.",
  Medium,
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.": "Hoppsan! Du använder en ej stödd metod (endast frontend). servera WebUI från backend.",
  "Open file": "Öppna fil",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat kan använda verktyg från alla OpenAPI-servrar.",
  "Omnichat uses faster-whisper internally.": "Omnichat använder faster-whisper internt.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat använder SpeechT5 och CMU Arctic högtalarinbäddningar.",
  "Omnichat version": "Öppna WebUI version",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Omnichat-versionen (v{{OPEN_WEBUI_VERSION}}) är lägre än den version som krävs (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Omdirigerar dig till OpenWebUI Community",
  ...
  "Share to Omnichat Community": "Dela till OpenWebUI Community",
