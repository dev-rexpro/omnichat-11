...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "A CORS-t megfelelően kell konfigurálnia a szolgáltatónak, hogy engedélyezze az Omnichat-ból érkező kéréseket.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Fedezd fel, hogyan használd az Omnichat-t és kérj támogatást a közösségtől.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Az OpenWebUI közösség által készítve",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Az Omnichat bármely OpenAPI szerver által biztosított eszközöket használhat.",
  "Omnichat uses faster-whisper internally.": "Az Omnichat belsőleg a faster-whispert használja.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Az Omnichat a SpeechT5-öt és a CMU Arctic hangszóró beágyazásokat használja.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Az Omnichat verzió (v{{OPEN_WEBUI_VERSION}}) alacsonyabb, mint a szükséges verzió (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Átirányítás az OpenWebUI közösséghez",
  ...
  "Share to Omnichat Community": "Megosztás az OpenWebUI közösséggel",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "A teljes hozzájárulása közvetlenül a bővítmény fejlesztőjéhez kerül; az Omnichat nem vesz le százalékot. Azonban a választott támogatási platformnak lehetnek saját díjai.",
