...
import { b0 as writable, o as onMount$1, b3 as state, l as get$1, k as set$1, B as tick, bT as svelte, bU as settled } from "./CISwU846.js";
class HttpError {
  /**
   * @param {number} status
...
const base = ((_a = globalThis.__sveltekit_13suct7) == null ? void 0 : _a.base) ?? "";
const assets = ((_b = globalThis.__sveltekit_13suct7) == null ? void 0 : _b.assets) ?? base ?? "";
const version = "22491cdc3a2daebd6e65e8d5d80ada679853f5de";
...
async function start(_app, _target, hydrate) {
  var _a2, _b2, _c2, _d2;
  if (globalThis.__sveltekit_13suct7) {
    globalThis.__sveltekit_13suct7.query ?? {};
    globalThis.__sveltekit_13suct7.prerender ?? {};
  }
...
function _start_router() {
  ...
  if (!((_a2 = navigator.connection) == null ? void 0 : _a2.saveData) && !/2g/.test((_b2 = navigator.connection) == null ? void 0 : _b2.effectiveType)) {
    setup_preload();
  }
