...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "El protocolo CORS debe estar configurado correctamente por el proveedor para permitir solicitudes desde Omnichat.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Descubre cómo usar Omnichat y busca Soporte Comunitario.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "¿Quieres sincronizar tus estadísticas de uso con Omnichat Community?",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Creado por la Comunidad Open-WebUI",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "El soporte de MCP es experimental y su especificación cambia con frecuencia, lo que puede generar incompatibilidades. El equipo de Omnichat mantiene directamente la compatibilidad con la especificación OpenAPI, lo que la convierte en la opción más fiable para la compatibilidad.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Open-WebUI puede usar herramientas proporcionadas por cualquier servidor OpenAPI",
  "Omnichat uses faster-whisper internally.": "Open-WebUI usa faster-whisper internamente.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Open-WebUI usa SpeechT5 y la incrustración de locutores de CMU Arctic.",
  "Omnichat version": "versión de Open-WebUI",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "La versión de Open-WebUI (v{{OPEN_WEBUI_VERSION}}) es inferior a la versión  (v{{REQUIRED_VERSION}}) requerida",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Redireccionando a la Comunidad Open-WebUI",
  ...
  "Share to Omnichat Community": "Compartir con la Comunidad Open-WebUI",
