...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "Teenusepakkuja peab nõuetekohaselt konfigureerima CORS-i, et lubada päringuid Omnichat-lt.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Avastage, kuidas kasutada Omnichat-d ja otsige tuge kogukonnalt.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Kas soovite sünkroniseerida oma kasutusstatistikat Omnichat kogukonnaga?",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Loodud Omnichat kogukonna poolt",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "MCP tugi on eksperimentaalne ja selle spetsifikatsioon muutub sageli, mis võib põhjustada ühildumatusi. OpenAPI spetsifikatsiooni tuge hooldab otseselt Omnichat meeskond, muutes selle ühilduvuse jaoks usaldusväärsemaks valikuks.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat saab kasutada iga OpenAPI serveri pakutavaid tööriistu.",
  "Omnichat uses faster-whisper internally.": "Omnichat kasutab sisemiselt faster-whisper'it.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat kasutab SpeechT5 ja CMU Arctic kõneleja manustamisi.",
  "Omnichat version": "Omnichat versioon",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Omnichat versioon (v{{OPEN_WEBUI_VERSION}}) on madalam kui nõutav versioon (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Omnichat. Your privacy is paramount: no message content is ever shared.": "Osalege kogukonna edetabelites ja hindamistes! Koondatud kasutusstatistika sünkroonimine aitab edendada uuringuid ja Omnichat täiustamist. Teie privaatsus on ülimalt oluline: sõnumite sisu ei jagata kunagi.",
  Password,
  ...
  "Redirecting you to Omnichat Community": "Suunamine Omnichat kogukonda",
  ...
  "Share to Omnichat Community": "Jaga Omnichat kogukonnaga",
