...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS ha de ser configurat correctament pel proveïdor per permetre les sol·licituds d'Omnichat",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Descobreix com utilitzar Omnichat i demana suport a la comunitat.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Vols sincronitzar les estadístiques d'ús amb la Omnichat Community?",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Creat per la Comunitat OpenWebUI",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "El suport per a MCP és experimental i la seva especificació canvia sovint, cosa que pot provocar incompatibilitats. El suport per a l'especificació d'OpenAPI el manté directament l'equip d'Omnichat, cosa que el converteix en l'opció més fiable per a la compatibilitat.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat pot utilitzar eines de servidors OpenAPI.",
  "Omnichat uses faster-whisper internally.": "Omnichat utilitza faster-whisper internament.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat utilitza incrustacions de SpeechT5 i CMU Arctic.",
  "Omnichat version": "Versió d'Omnichat",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "La versió d'Omnichat (v{{OPEN_WEBUI_VERSION}}) és inferior a la versió requerida (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Redirigint-te a la comunitat OpenWebUI",
  ...
  "Share to Omnichat Community": "Compartir amb la comunitat OpenWebUI",
