...
import { x as getDMChannelByUserId } from "./DrOJmvdE.js";
...
import { t as tabbable, a as focusable, i as isFocusable } from "./CZ-Bw2qQ.js";
...
function UserStatus($$anchor, $$props) {
  ...
  var node = first_child(fragment);
  {
    var consequent_6 = ($$anchor2) => {
      ...
      reset(div);
      template_effect(() => {
        set_attribute(img, "src", (deep_read_state(WEBUI_API_BASE_URL), deep_read_state(user$1()), untrack(() => {
          var _a;
          return `${WEBUI_API_BASE_URL}/users/${(_a = user$1()) == null ? void 0 : _a.id}/profile/image`;
        })));
