...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "Omnichatからのリクエストを許可するために、プロバイダーによってCORSが適切に設定されている必要があります。",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Omnichatの使用方法を探し、コミュニティからサポートを求めてください。",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "OpenWebUI コミュニティによって作成",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "OpenWebUI は任意のOpenAPI サーバーが提供するツールを使用できます。",
  "Omnichat uses faster-whisper internally.": "OpenWebUI は内部でfaster-whisperを使用します。",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "OpenWebUI は SpeechT5とCMU Arctic スピーカー埋め込みを使用します。",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "OpenWebUI のバージョン (v{{OPEN_WEBUI_VERSION}}) は要求されたバージョン (v{{REQUIRED_VERSION}}) より低いです。",
  OpenAI,
  ...
  Record,
  "Record voice": "音声を録音",
  "Redirecting you to Omnichat Community": "OpenWebUI コミュニティにリダイレクトしています",
  ...
  "Share to Omnichat Community": "OpenWebUI コミュニティに共有",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "あなたの全ての寄付はプラグイン開発者へ直接送られます。Omnichat は手数料を一切取りません。ただし、選択した資金提供プラットフォーム側に手数料が発生する場合があります。",
