...
const translation = {
  ...
  "Discover how to use Omnichat and seek support from the community.": "Εξερευνήστε πως να χρησιμοποιήσετε το Omnichat και αναζητήστε βοήθεια στην κοινότητα.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Δημιουργήθηκε από την Κοινότητα OpenWebUI",
  ...
  "Omnichat uses faster-whisper internally.": "Το Omnichat χρησιμοποιεί το faster-whisper εσωτερικά.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Το Omnichat χρησιμοποιεί τα SpeechT5 και CMU Arctic ενσωματώσεων ομιλητών.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Η έκδοση Omnichat (v{{OPEN_WEBUI_VERSION}}) είναι χαμηλότερη από την απαιτούμενη έκδοση (v{{REQUIRED_VERSION}})",
  OpenAI,
  "OpenAI API": "",
  "OpenAI API Base URL": "",
  "OpenAI API Key": "",
  ...
  "Redirecting you to Omnichat Community": "Μετακατεύθυνση στην Κοινότητα OpenWebUI",
  ...
  "Share to Omnichat Community": "Κοινή Χρήση στην Κοινότητα OpenWebUI",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "Η ολόκληρη η συνεισφορά σας θα πάει απευθείας στον προγραμματιστή του plugin· το Omnichat δεν παίρνει κανένα ποσοστό. Ωστόσο, η επιλεγμένη πλατφόρμα χρηματοδότησης μπορεί να έχει τα δικά της τέλη.",
