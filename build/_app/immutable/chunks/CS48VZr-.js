...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS ilaq ad yeswel akken iwata sɣur usaǧǧaw akken ad yeǧǧ issutren seg WebUI yeldin.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Wali amek ara tesqedceḍ Omnichat udiɣ amek ara ad tnadiḍ tallelt ar temɣiwant.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Texdem-it-id temɣiwant n Omnichat",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat yezmer ad yesseqdec ifecka i d-yettak yal aqeddac OpenAPI.",
  "Omnichat uses faster-whisper internally.": "Omnichat yesseqdac faster-whisper sdaxel-is.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Ldi WebUI yesseqdac SpeechT5 akked CMU Arktik.",
  "Omnichat version": "",
  ...
  "Redirecting you to Omnichat Community": "Aseḍfeṛ ar Temɣiwant n Omnichat",
  ...
  "Share to Omnichat Community": "Bḍu i tkebbanit WebUI yeldin",
