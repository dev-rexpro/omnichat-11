const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./BE-Minck.js","./CQrtv1eE.js","./HHsaTunm.js","./OO7lCI-F.js","./BwSDK2sm.js","./DRQY1RPo.js"])))=>i.map(i=>d[i]);
import "./DKem_M_z.js";
import "./DwLkIEu4.js";
import { t as template_effect, a as append, F as from_svg, p as push, o as onMount, v as onDestroy, l as get, k as set, c as child, n as sibling, r as reset, b as pop, m as mutable_source, d as set_text, z as untrack, q as event, f as from_html, aW as mutate, g as getContext, w as legacy_pre_effect, x as deep_read_state, y as legacy_pre_effect_reset, s as setup_stores, B as tick, i as first_child, E as next, D as text, u as derived_safe_equal, h as comment, e as store_get, C as createEventDispatcher } from "./CISwU846.js";
...
import { G as pdfWorkerUrl, H as formatFileSize, I as getLineCount } from "./7pK2BKln.js";
...
import { g as getKnowledgeById } from "./v2cJtl5e.js";
import { g as getFileById, a as getFileContentById } from "./BKQxLosz.js";
import { p as panzoom, R as Reset, P as PanzoomContainer, C as CodeBlock, M as Markdown } from "./CiZwScVd.js";
...
import { F as Folder, D as DocumentPage } from "./D985XlXF.js";
...
var root$4 = from_html(`<div class="absolute inset-0 flex items-center justify-center"><!></div>`);
...
var root$3 = from_html(`<div class="capitalize shrink-0"> </div> •`, 1);
...
function FileItemModal($$anchor, $$props) {
  ...
  const loadExcelContent = async () => {
    try {
      set(excelError, "");
      const [arrayBuffer, { read }] = await Promise.all([getFileContentById(item().id), __vitePreload(() => import("./B5iIhWBE.js"), true ? [] : void 0, import.meta.url)]);
  ...
  const renderExcelSheet = async () => {
    ...
    const { excelToTable } = await __vitePreload(async () => {
      const { excelToTable: excelToTable2 } = await import("./BE-Minck.js");
  ...
  const loadDocxContent = async () => {
    try {
      set(docxError, "");
      const [arrayBuffer, mammoth] = await Promise.all([getFileContentById(item().id), __vitePreload(() => import("./HHsaTunm.js").then((n) => n.i), true ? __vite__mapDeps([2,3,4]) : void 0, import.meta.url)]);
  ...
  const loadPptxContent = async () => {
    try {
      ...
      const [arrayBuffer, { pptxToImages }] = await Promise.all([
        ...
        __vitePreload(() => import("./DRQY1RPo.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url)
      ]);
    ...
    children: ($$anchor2, $$slotProps) => {
              ...
              bind_this(
                PanzoomContainer(node_19, {
                  children: ($$anchor5, $$slotProps2) => {
                    var img = root_11();
                    template_effect(() => {
                      set_attribute(img, "src", (deep_read_state(WEBUI_API_BASE_URL), deep_read_state(item()), untrack(() => `${WEBUI_API_BASE_URL}/files/${item().id}/content`)));
            ...
            var consequent_35 = ($$anchor4) => {
              ...
              var node_27 = first_child(fragment_16);
              {
                ...
                var consequent_21 = ($$anchor5) => {
                  {
                    let $0 = derived_safe_equal(() => (deep_read_state(WEBUI_API_BASE_URL), deep_read_state(item()), untrack(() => `${WEBUI_API_BASE_URL}/files/${item().id}/content`)));
                    PDFViewer($$anchor5, {
                      get url() {
                        return get($0);
                      },
      ...
      event("click", a, preventDefault(() => {
        ...
        if (item().type === "file" || item().url) {
          ...
          window.open(
            item().type === "file" ? ((_d = (_c = item()) == null ? void 0 : _c.url) == null ? void 0 : _d.startsWith("http")) ? item().url : `${WEBUI_API_BASE_URL}/files/${fileId}/content` : item().url,
            "_blank"
          );
        }
      }));
