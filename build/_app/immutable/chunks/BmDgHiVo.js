...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "Le réglage CORS doit être correctement configuré par le fournisseur pour autoriser les requêtes provenant de l'Omnichat.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Découvrez comment utiliser Omnichat et obtenir de l'aide de la communauté.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Souhaitez-vous synchroniser vos statistiques d'utilisation avec la communauté Omnichat ?",
  Docling,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-webui": "Inclure le flag `--api-auth` lors de l'exécution de stable-diffusion-webui",
  "Include `--api` flag when running stable-diffusion-webui": "Inclure le flag `--api` lors de l'exécution de stable-diffusion-webui",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Réalisé par la communauté OpenWebUI",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "Le support du MCP est expérimental et sa spécification évolue fréquemment, ce qui peut entraîner des incompatibilités. Le support de la spécification OpenAPI est directement maintenu par l'équipe Omnichat, ce qui en fait l'option la plus fiable en termes de compatibilité.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat peut utiliser les outils fournis par n'importe quel serveur OpenAPI.",
  "Omnichat uses faster-whisper internally.": "Omnichat utilise faster-whisper en interne.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat utilise SpeechT5 et les embeddings de locuteur CMU Arctic.",
  "Omnichat version": "Version d'Omnichat",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "La version Omnichat (v{{OPEN_WEBUI_VERSION}}) est inférieure à la version requise (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Redirection vers la communauté OpenWebUI",
  ...
  "Share to Omnichat Community": "Partager avec la communauté OpenWebUI",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "L'intégralité de votre contribution ira directement au développeur du plugin ; Omnichat ne prend aucun pourcentage. Cependant, la plateforme de financement choisie peut avoir ses propres frais.",
