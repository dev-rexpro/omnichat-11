...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "O CORS deve ser configurado corretamente pelo provedor para permitir solicitações do Omnichat.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Descubra como usar o Omnichat e busque suporte da comunidade.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Deseja sincronizar suas estatísticas de uso com a Comunidade Omnichat?",
  Docling,
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "O suporte ao MCP é experimental e suas especificações mudam com frequência, o que pode levar a incompatibilidades. O suporte à especificação OpenAPI é mantido diretamente pela equipe do Omnichat, tornando-o a opção mais confiável para compatibilidade.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "O Omnichat pode usar ferramentas fornecidas por qualquer servidor OpenAPI.",
  "Omnichat uses faster-whisper internally.": "Omnichat usa faster-whisper internamente.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "A Omnichat usa os embeddings de voz do SpeechT5 e do CMU Arctic.",
  "Omnichat version": "Versão do Omnichat",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "A versão do Omnichat (v{{OPEN_WEBUI_VERSION}}) é inferior à versão necessária (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Redirecionando você para a Comunidade OpenWebUI",
  ...
  "Share to Omnichat Community": "Compartilhar com a Comunidade OpenWebUI",
