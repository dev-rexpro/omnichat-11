...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS deve essere configurato correttamente dal fornitore per consentire le richieste da Omnichat.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Scopri come utilizzare Omnichat e cerca supporto dalla community.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Realizzato dalla Comunità Omnichat",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat può utilizzare tool forniti da qualsiasi server OpenAPI.",
  "Omnichat uses faster-whisper internally.": "Omnichat utilizza faster-whisper internamente.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat utilizza le incorporazioni vocali di SpeechT5 e CMU Arctic.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "La versione di Omnichat (v{{OPEN_WEBUI_VERSION}}) è inferiore alla versione richiesta (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Reindirizzamento alla comunità OpenWebUI",
  ...
  "Share to Omnichat Community": "Condividi con la comunità OpenWebUI",
