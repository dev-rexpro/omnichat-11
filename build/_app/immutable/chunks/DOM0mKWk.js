...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "O CORS debe estar debidamente configurado polo provedor para permitir solicitudes desde Omnichat.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Descubra como usar Omnichat e busque apoio na comunidade.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Feito por a comunidad de OpenWebUI",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "",
  "Omnichat uses faster-whisper internally.": "Omnichat usa faster-whisper internamente.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat usa SpeechT5 y embeddings de locutores CMU Arctic.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Aversión de Omnichat (v{{OPEN_WEBUI_VERSION}}) es inferior a aversión requerida (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Redireccionándote a a comunidad OpenWebUI",
  ...
  "Share to Omnichat Community": "Compartir coa comunidads OpenWebUI",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "A sua contribución completa irá directamente o desarrollador do plugin; Omnichat non toma ningun porcentaxe. Sin embargo, a plataforma de financiación elegida podría ter as suas propias tarifas.",
