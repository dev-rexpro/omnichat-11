...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS moet goed geconfigureerd zijn bij de provider om verzoeken van Omnichat toe te staan",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Ontdek hoe je Omnichat gebruikt en zoek ondersteuning van de community.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Wil je je gebruiksstatistieken synchroniseren met Omnichat Community?",
  Docling,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-webui": "Voeg de `--api-auth`-vlag toe bij het uitvoeren van stable-diffusion-webui",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Gemaakt door OpenWebUI Community",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "MCP-ondersteuning is experimenteel en de specificatie verandert vaak, wat tot incompatibiliteiten kan leiden. Ondersteuning voor de OpenAPI-specificatie wordt direct onderhouden door het Omnichat-team, waardoor dit de betrouwbaardere optie voor compatibiliteit is.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat kan tools gebruiken die door elke OpenAPI-server worden geleverd.",
  "Omnichat uses faster-whisper internally.": "Omnichat gebruikt faster-whisper intern",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat gebruikt SpeechT5 en CMU Arctic spreker-embeddings",
  "Omnichat version": "Omnichat-versie",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Omnichat versie (v{{OPEN_WEBUI_VERSION}}) is kleiner dan de benodigde versie (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Je wordt doorgestuurd naar OpenWebUI Community",
  ...
  "Share to Omnichat Community": "Deel naar OpenWebUI-community",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "Je volledige bijdrage gaat direct naar de ontwikkelaar van de plugin; Omnichat neemt hier geen deel van. Het gekozen financieringsplatform kan echter wel zijn eigen kosten hebben.",
