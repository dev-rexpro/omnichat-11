...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "Omnichat’dan gelen isteklerin kabul edilebilmesi için sağlayıcının CORS yapılandırmasının doğru şekilde yapılmış olması gerekir.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Omnichat'yi nasıl kullanacağınızı keşfedin ve topluluktan destek alın.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Kullanım istatistiklerinizi Omnichat Community ile senkronize etmek istiyor musunuz?",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "OpenWebUI Topluluğu tarafından yapılmıştır",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "MCP desteği deneyseldir ve belirtimi sık sık değiştiği için uyumsuzluklara yol açabilir. OpenAPI belirtim desteği doğrudan Omnichat ekibi tarafından sürdürülür ve bu da onu uyumluluk açısından daha güvenilir seçenek yapar.",
  Medium,
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.": "Hay aksi! Desteklenmeyen bir yöntem kullanıyorsunuz (yalnızca önyüz). Lütfen WebUI'yi arka uçtan sunun.",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat OpenAPI tarafından sağlanan araçları kullanabilir",
  "Omnichat uses faster-whisper internally.": "Omnichat, dahili olarak faster-whisper kullanır.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat, SpeechT5 ve CMU Arctic konuşmacı gömme kullanır.",
  "Omnichat version": "Omnichat sürümü",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Open-WebUI sürümü (v{{OPEN_WEBUI_VERSION}}) gerekli sürümden (v{{REQUIRED_VERSION}}) düşük",
  OpenAI,
  ...
  "Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Omnichat. Your privacy is paramount: no message content is ever shared.": "Topluluk lider tablolarına ve değerlendirmelerine katılın! Toplu kullanım istatistiklerini eşitlemek, Omnichat'nin araştırmasına ve iyileştirilmesine yardımcı olur. Gizliliğiniz her şeyden önemlidir: hiçbir zaman mesaj içeriği paylaşılmaz.",
  Password,
  ...
  "Redirecting you to Omnichat Community": "OpenWebUI Topluluğuna yönlendiriliyorsunuz",
  ...
  "Share to Omnichat Community": "OpenWebUI Topluluğu ile Paylaş",
  ...
  'WebUI will make requests to "{{url}}"': 'WebUI, "{{url}}" adresine istek gönderecek',
