...
const translation = {
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "اوپن ویب یو آئی کمیونٹی کی جانب سے تیار کردہ",
  ...
  "Omnichat uses faster-whisper internally.": "اوپن ویب یو آئی اندرونی طور پر فاسٹر وِسپر استعمال کرتا ہے",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "اوپن WebUI ورژن (v{{OPEN_WEBUI_VERSION}}) مطلوبہ ورژن (v{{REQUIRED_VERSION}}) سے کم ہے",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "آپ کو اوپن ویب یو آئی کمیونٹی کی طرف ری ڈائریکٹ کیا جا رہا ہے",
  ...
  "Share to Omnichat Community": "اوپن ویب یوآئی کمیونٹی کے ساتھ شیئر کریں\n",
