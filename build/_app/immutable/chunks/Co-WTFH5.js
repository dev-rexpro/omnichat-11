...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "Omnichatنىڭ تەلىپكە ئىجازەت بېرىش ئۈچۈن CORS توغرا تەڭشىلىشى كېرەك.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Omnichat ئىشلىتىشنى ئۈگىنڭ ۋە جەمئىيەتتىن ياردەم سوراڭ.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Omnichat جەمئىيىتى تەرىپىدىن قۇرۇلغان",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat ھەر قانداق OpenAPI مۇلازىمېتىرلىرىدىكى قوراللارنى ئىشلىتەلىدۇ.",
  "Omnichat uses faster-whisper internally.": "Omnichat ئىچىدە faster-whisper ئىشلىتىدۇ.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat SpeechT5 ۋە CMU Arctic ئاۋاز سىڭدۈرۈش ئىشلىتىدۇ.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Omnichat نەشرى (v{{OPEN_WEBUI_VERSION}}) تەلەپ قىلىنغان نەشردىن (v{{REQUIRED_VERSION}}) تۆۋەن.",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Omnichat جەمئىيىتىگە يوللاندى",
  ...
  "Share to Omnichat Community": "Omnichat جەمئىيىتىگە ھەمبەھىرلەش",
