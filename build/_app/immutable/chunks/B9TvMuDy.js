...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "为允许 Omnichat 发出的请求，提供商必须正确配置 CORS",
  ...
  "Discover how to use Omnichat and seek support from the community.": "了解如何使用 Omnichat 并寻求社区支持",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "您希望将使用统计数据同步至 Omnichat 社区吗？",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "由 Omnichat 社区开发",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "MCP 支持仍处于实验阶段，因其规范变化频繁，可能会出现不兼容的情况。而 OpenAPI 规范由 Omnichat 团队维护，在兼容性方面更加可靠。",
  Medium,
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.": "您正在使用不受支持的方法（仅运行前端服务）。请通过后端服务提供 WebUI。",
  "Open file": "打开文件",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat 可使用任何 OpenAPI 服务器提供的工具。",
  "Omnichat uses faster-whisper internally.": "Omnichat 使用内置 faster-whisper",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat 使用 SpeechT5 和 CMU Arctic speaker embedding。",
  "Omnichat version": "Omnichat 版本",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "当前 Omnichat 版本 (v{{OPEN_WEBUI_VERSION}}) 低于所需的版本 (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Omnichat. Your privacy is paramount: no message content is ever shared.": "欢迎您参与社区排行榜和评估！同步使用统计数据有助于 Omnichat 的研发和改进。您的隐私至关重要：我们绝不会发送任何消息内容。",
  Password,
  ...
  Record,
  "Record voice": "录音",
  "Redirecting you to Omnichat Community": "正在将您重定向到 Omnichat 社区",
  ...
  "Share to Omnichat Community": "分享到 Omnichat 社区",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "您的全部捐款将直接给到插件开发者，Omnichat 不会收取任何分成。但众筹平台可能会有服务费。",
