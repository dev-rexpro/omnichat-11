...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "ผู้ให้บริการต้องกำหนดค่า CORS ให้ถูกต้องเพื่ออนุญาตคำขอจาก Omnichat",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "เรียนรู้วิธีใช้ Omnichat และขอความช่วยเหลือจากชุมชน",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "สร้างโดยชุมชน Omnichat",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "การรองรับ MCP ยังเป็นแบบทดลองและมีการเปลี่ยนแปลงสเปกบ่อยครั้ง ซึ่งอาจทำให้เกิดปัญหาความไม่เข้ากันได้ การรองรับสเปก OpenAPI นั้นดูแลโดยทีม Omnichat โดยตรง จึงเป็นตัวเลือกที่เชื่อถือได้มากกว่าในด้านความเข้ากันได้",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat สามารถใช้เครื่องมือที่มีให้จากเซิร์ฟเวอร์ OpenAPI ใดก็ได้",
  "Omnichat uses faster-whisper internally.": "Omnichat ใช้ faster-whisper อยู่ภายใน",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat ใช้ SpeechT5 และ Embedding เสียงผู้พูด CMU Arctic",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "เวอร์ชัน Omnichat (v{{OPEN_WEBUI_VERSION}}) ต่ำกว่าเวอร์ชันที่ต้องการ (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "กำลังเปลี่ยนเส้นทางคุณไปยังชุมชน Omnichat",
  ...
  "Share to Omnichat Community": "แชร์ไปยังชุมชน Omnichat",
