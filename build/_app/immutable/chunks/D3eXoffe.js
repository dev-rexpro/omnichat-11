...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "Omnichat сўровларига рухсат бериш учун CORS провайдер томонидан тўғри созланган бўлиши керак.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Omnichatдан қандай фойдаланишни билиб олинг ва ҳамжамиятдан ёрдам сўранг.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Опен WебУИ ҳамжамияти томонидан яратилган",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Опен WебУИ ҳар қандай ОпенАПИ сервери томонидан тақдим этилган воситалардан фойдаланиши мумкин.",
  "Omnichat uses faster-whisper internally.": "Опен WебУИ ички тез шивирлашдан фойдаланади.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Опен WебУИ СпеэчТ5 ва CМУ Арcтиc динамик ўрнатишларидан фойдаланади.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Очиқ WебУИ версияси (в{{ОПЕН_WЕБУИ_ВЕРСИОН}}) талаб қилинган версиядан (в{{РЕҚУИРЕД_ВЕРСИОН}}) пастроқ",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Сизни Опен WебУИ ҳамжамиятига йўналтирмоқда",
  ...
  "Share to Omnichat Community": "Опен WебУИ ҳамжамиятига улашинг",
