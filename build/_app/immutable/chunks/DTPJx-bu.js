...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS må være riktig konfigurert av leverandøren for å kunne godkjenne forespørsler fra Omnichat.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Finn ut hvordan du bruker Omnichat, og få støtte fra fellesskapet.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Laget av OpenWebUI-fellesskapet",
  ...
  "Omnichat uses faster-whisper internally.": "Omnichat bruker faster-whisper internt.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat bruker SpeechT5 og CMU Arctic-høytalerinnbygginger",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Omnichat-versjonen (v{{OPEN_WEBUI_VERSION}}) er lavere enn den påkrevde versjonen (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Omdirigerer deg til OpenWebUI-fellesskapet",
  ...
  "Share to Omnichat Community": "Del med OpenWebUI-fellesskapet",
