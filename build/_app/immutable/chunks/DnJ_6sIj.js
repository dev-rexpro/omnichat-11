...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS трябва да бъде правилно конфигуриран от доставчика, за да позволи заявки от Omnichat.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Открийте как да използвате Omnichat и потърсете подкрепа от общността.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Направено от OpenWebUI общността",
  ...
  "Omnichat uses faster-whisper internally.": "Omnichat използва вътрешно по-бързо-whisper.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat използва SpeechT5 и CMU Arctic говорителни вграждания.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Версията на Omnichat (v{{OPEN_WEBUI_VERSION}}) е по-ниска от необходимата версия (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Пренасочване към OpenWebUI общността",
  ...
  "Share to Omnichat Community": "Споделете с OpenWebUI Общността",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "Цялата ви вноска ще отиде директно при разработчика на плъгина; Omnichat не взима никакъв процент. Въпреки това, избраната платформа за финансиране може да има свои собствени такси.",
