...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "Omnichat의 요청을 허용하려면 공급자가 CORS를 올바르게 구성해야 합니다.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Omnichat 사용 방법을 알아보고 커뮤니티에서 지원을 받으세요.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "사용 통계를 Omnichat 커뮤니티와 동기화하시겠습니까?",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "OpenWebUI 커뮤니티에 의해 개발됨",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "MCP 지원은 실험적이며 명세가 자주 변경되므로, 호환성 문제가 발생할 수 있습니다. Omnichat 팀이 OpenAPI 명세 지원을 직접 유지·관리하고 있어, 호환성 측면에서는 더 신뢰할 수 있는 선택입니다.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat는 모든 OpenAPI 서버에서 제공하는 도구를 사용할 수 있습니다.",
  "Omnichat uses faster-whisper internally.": "Omnichat는 내부적으로 패스트 위스퍼를 사용합니다.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat는 SpeechT5와 CMU Arctic 스피커 임베딩을 사용합니다.",
  "Omnichat version": "Omnichat 버전",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "열린 WebUI 버젼(v{{OPEN_WEBUI_VERSION}})은 최소 버젼 (v{{REQUIRED_VERSION}})보다 낮습니다",
  OpenAI,
  ...
  "Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Omnichat. Your privacy is paramount: no message content is ever shared.": "커뮤니티 리더보드와 평가에 참여하세요! 집계된 사용 통계를 동기화하면 Omnichat의 연구과 개선을 지원합니다. 귀하의 개인정보는 최우선으로 보호됩니다: 메시지 내용은 절대 공유되지 않습니다.",
  Password,
  ...
  Record,
  "Record voice": "음성 녹음",
  "Redirecting you to Omnichat Community": "OpenWebUI 커뮤니티로 리디렉션 중",
  ...
  "Share to Omnichat Community": "OpenWebUI 커뮤니티에 공유",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "당신의 모든 기여는 곧바로 플러그인 개발자에게 갑니다; Omnichat는 수수료를 받지 않습니다. 다만, 선택한 후원 플랫폼은 수수료를 가져갈 수 있습니다.",
