...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS должен быть должным образом настроен провайдером, чтобы разрешать запросы из Omnichat.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Узнайте, как использовать Omnichat, и обратитесь за поддержкой к сообществу.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Хотите синхронизировать статистику использования с сообществом Omnichat?",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Сделано сообществом OpenWebUI",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "Поддержка MCP является экспериментальной, а частые изменения спецификации могут приводить к несовместимостям. Поддержка OpenAPI напрямую обеспечивается командой Omnichat, что делает её более надёжным вариантом.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat может использовать инструменты, предоставляемые любым сервером OpenAPI.",
  "Omnichat uses faster-whisper internally.": "Omnichat использует faster-whisper внутри.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat использует SpeechT5 и голосовые эмбеддинги CMU Arctic.",
  "Omnichat version": "Версия Omnichat",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Версия Omnichat (v{{OPEN_WEBUI_VERSION}}) ниже требуемой версии (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Перенаправляем вас в сообщество OpenWebUI",
  ...
  "Share to Omnichat Community": "Поделиться с сообществом OpenWebUI",
