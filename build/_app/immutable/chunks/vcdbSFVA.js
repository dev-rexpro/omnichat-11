...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "Ní mór don soláthraí CORS a chumrú i gceart chun iarratais ó Omnichat a cheadú.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Faigh amach conas Omnichat a úsáid agus lorg tacaíocht ón bpobal.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Ar mhaith leat do staitisticí úsáide a shioncronú le Pobal Omnichat?",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Déanta ag OpenWebUI Community",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "Is turgnamhach tacaíocht MCP agus athraítear a shonraíocht go minic, rud a d’fhéadfadh neamh-chomhoiriúnachtaí a bheith mar thoradh air. Déanann foireann Omnichat cothabháil dhíreach ar thacaíocht sonraíochta OpenAPI, rud a fhágann gurb é an rogha is iontaofa é le haghaidh comhoiriúnachta.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Is féidir le WebUI Oscailte uirlisí a úsáid a sholáthraíonn aon fhreastalaí OpenAPI.",
  "Omnichat uses faster-whisper internally.": "Úsáideann Omnichat cogar níos tapúla go hinmheánach.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Úsáideann Omnichat úsáidí SpeechT5 agus CMU leabaithe cainteoir Artach.",
  "Omnichat version": "Oscail leagan WebUI",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Tá leagan WebUI oscailte (v{{OPEN_WEBUI_VERSION}}) níos ísle ná an leagan riachtanach (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Tú a atreorú chuig OpenWebUI Community",
  ...
  "Share to Omnichat Community": "Comhroinn le Pobal OpenWebUI",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "Rachaidh do ranníocaíocht iomlán go díreach chuig an bhforbróir breiseán; Ní ghlacann Omnichat aon chéatadán. Mar sin féin, d'fhéadfadh a tháillí féin a bheith ag an ardán maoinithe roghnaithe.",
