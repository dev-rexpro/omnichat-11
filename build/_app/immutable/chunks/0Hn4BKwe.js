...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "يجب أن يتم تكوين CORS بشكل صحيح من قبل المزود للسماح بالطلبات من Omnichat.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "اكتشف كيفية استخدام Omnichat واطلب الدعم من المجتمع.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "OpenWebUI تم إنشاؤه بواسطة مجتمع ",
  ...
  "Omnichat uses faster-whisper internally.": "تستخدم واجهة WebUI أداة faster-whisper داخليًا.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "تستخدم WebUI نموذج SpeechT5 وتضمينات صوتية من CMU Arctic.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "إصدار WebUI الحالي (v{{OPEN_WEBUI_VERSION}}) أقل من الإصدار المطلوب (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "OpenWebUI إعادة توجيهك إلى مجتمع ",
  ...
  "Share to Omnichat Community": "OpenWebUI شارك في مجتمع",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "سيتم توجيه كامل مساهمتك مباشرة إلى مطور المكون الإضافي؛ لا تأخذ Omnichat أي نسبة. ومع ذلك، قد تفرض منصة التمويل المختارة رسومًا خاصة بها.",
