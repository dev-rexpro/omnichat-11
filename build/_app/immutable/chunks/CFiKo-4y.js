...
import "./DKem_M_z.js";
import "./DwLkIEu4.js";
import { p as push, g as getContext, C as createEventDispatcher, o as onMount, k as set, l as get, w as legacy_pre_effect, x as deep_read_state, y as legacy_pre_effect_reset, i as first_child, z as untrack, n as sibling, c as child, r as reset, t as template_effect, d as set_text, q as event, a as append, aX as remove_textarea_child, b as pop, e as store_get, s as setup_stores, m as mutable_source, D as text, u as derived_safe_equal, f as from_html, E as next, h as comment, A as user_derived, B as tick, v as onDestroy, F as from_svg, X as effect, aW as mutate, bJ as store_mutate } from "./CISwU846.js";
import { i as if_block } from "./Cr87xL-z.js";
import { k as key } from "./-PfhJFwZ.js";
import { e as each, i as index } from "./D16NL_tt.js";
import { a as set_attribute, s as set_class, r as remove_input_defaults, c as clsx, b as set_value, d as set_style } from "./CpNYkTX2.js";
import { b as bind_prop } from "./CGyv6Yf5.js";
import { i as init } from "./CDjUy0iz.js";
import { p as prop } from "./BFaWdt2I.js";
import { a as models, c as config, B as tags, b as settings, K as showControls, M as showEmbeds, N as embed, O as artifactCode, P as showArtifacts, m as mobile, g as chatId, u as user, Q as audioQueue, T as TTSWorker, H as temporaryChatEnabled, W as WEBUI_NAME, z as currentChatPage, A as chats } from "./C2d9K3Bp.js";
import { t as toast } from "./C-rLN5eo.js";
import { a as getChatById, m as updateChatById, j as getChatList } from "./D5cOGyvj.js";
import { O as replaceOutsideCode, r as formatDate, h as createMessagesList, P as removeAllDetails, m as copyToClipboard, Q as sanitizeResponseContent, R as getMessageContentParts, v as v4 } from "./7pK2BKln.js";
...
import { u as updateFeedbackById, h as createNewFeedback } from "./Z08MFZzy.js";
import { f as generateTags } from "./EH47ywF7.js";
import { s as synthesizeOpenAISpeech } from "./BrRtFY2h.js";
import { b as WEBUI_API_BASE_URL, a as WEBUI_BASE_URL, W as WEBUI_VERSION } from "./Cjpn_aRT.js";
import { a as Info, i as injectCsp, M as Markdown, C as CodeBlock, L as LightBulb, e as equal, I as Image, F as FullHeightIframe, S as Sparkles, B as Bolt } from "./CiZwScVd.js";
import { P as ProfileImage, N as Name } from "./BZV2Wl24.js";
import { S as Skeleton, F as Fuse } from "./DIvZspYJ.js";
import { T as Tooltip } from "./ThfTFFN0.js";
import { T as Tags } from "./lr-AhN0K.js";
import { X as XMark } from "./DBwFTtKj.js";
import { C as ChevronRight } from "./B_BET3Ob.js";
import "./8-FuG-sv.js";
import "./CQqKGJai.js";
...
import { c as component } from "./D_oz8EBX.js";
import { C as ChatBubble, F as FileItem } from "./DeM0jLky.js";
...
import { C as Collapsible } from "./D_DGpmzS.js";
import "./DfSR1r5E.js";
import { a as action } from "./22PI2KxS.js";
import { E as EditorView, M as EditorState, S as basicSetup, o as keymap, U as indentWithTab, H as indentUnit, V as Compartment, W as oneDark } from "./Cbu9vZ_m.js";
import { json } from "./DoKqpC_i.js";
import { l as localizedFormat } from "./_xypnXqU.js";
import { L as Loader } from "./CLJcSX52.js";
  ...
  var node_5 = sibling(div_14, 2);
  {
    var consequent_16 = ($$anchor2) => {
      ...
      template_effect(
        ...
        [
          () => (deep_read_state(message()), untrack(() => `https://omnichat.rexpro.com/models?q=${encodeURIComponent(message().model)}`)),
...
function CitationModal($$anchor, $$props) {
  ...
  const getTextFragmentUrl = (doc) => {
    ...
    const baseUrl = file_id ? `${WEBUI_API_BASE_URL}/files/${file_id}/content${page !== void 0 ? `#page=${page + 1}` : ""}` : (sourceUrl == null ? void 0 : sourceUrl.includes("http")) ? sourceUrl : null;
...
function WorkerWrapper(options) {
  return new Worker(
    "" + new URL("../workers/kokoro.worker-DIWw8Emm.js", import.meta.url).href,
    {
      type: "module",
...
function UserMessage($$anchor, $$props) {
  ...
  var node_1 = child(div);
  {
    var consequent = ($$anchor2) => {
      ...
      var node_2 = child(div_1);
      {
        let $0 = derived_safe_equal(() => (deep_read_state(user$1()), deep_read_state(WEBUI_API_BASE_URL), deep_read_state(WEBUI_BASE_URL), untrack(() => {
          var _a;
          return ((_a = user$1()) == null ? void 0 : _a.id) ? `${WEBUI_API_BASE_URL}/users/${user$1().id}/profile/image` : `${WEBUI_BASE_URL}/static/favicon.png`;
        })));
        ProfileImage(node_2, {
          get src() {
            return get($0);
      ...
      var node_10 = first_child(fragment_5);
      {
        var consequent_7 = ($$anchor3) => {
          ...
          each(div_8, 5, () => (get(message), untrack(() => get(message).files)), index, ($$anchor4, file) => {
            const fileUrl = derived_safe_equal(() => (get(file), deep_read_state(WEBUI_API_BASE_URL), untrack(() => {
              var _a, _b, _c;
              return ((_a = get(file).url) == null ? void 0 : _a.startsWith("data")) || ((_b = get(file).url) == null ? void 0 : _b.startsWith("http")) ? get(file).url : `${WEBUI_API_BASE_URL}/files/${get(file).url}${((_c = get(file)) == null ? void 0 : _c.content_type) ? "/content" : ""}`;
            })));
            var div_9 = root$4();
...
var root$1 = from_html(`<img class=" size-[2.7rem] rounded-full border-[1px] border-gray-100 dark:border-none" alt="logo" draggable="false"/>`);
          ...
          var consequent_3 = ($$anchor4) => {
            ...
            var node_7 = sibling(child(div_9));
            {
              var consequent_2 = ($$anchor5) => {
                ...
                reset(a);
                template_effect(() => {
                  set_attribute(a, "href", `https://omnichat.rexpro.com/m/${(deep_read_state(models$1()), get(selectedModelIdx), untrack(() => {
                    var _a, _b, _c;
