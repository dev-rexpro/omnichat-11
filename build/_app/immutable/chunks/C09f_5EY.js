...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS skal være korrekt konfigureret af udbyderen for at tillade anmodninger fra Omnichat.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Opdag hvordan du bruger Omnichat og søg støtte fra fællesskabet.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Lavet af OpenWebUI Community",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "MCP understøttelse er eksperimentel og dens specifikationer ændres ofte hvilket kan medføre inkompatibilitet. OpenAI specifikationsunderstøttelse er vedligeholdt af Omnichat-teamet hvilket gør det til den mest pålidelige mulighed for understøttelse.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat kan bruge værktøjer leveret af enhver OpenAPI server.",
  "Omnichat uses faster-whisper internally.": "Omnichat bruger faster-whisper internt.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat bruger SpeechT5 og CMU Arctic taler embeddings.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Omnichat-version (v{{OPEN_WEBUI_VERSION}}) er lavere end den krævede version (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Omdirigerer dig til OpenWebUI Community",
  ...
  "Share to Omnichat Community": "Del til OpenWebUI Community",
