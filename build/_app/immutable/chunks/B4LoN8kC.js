...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS باید توسط ارائه‌دهنده به درستی پیکربندی شود تا درخواست‌ها از Omnichat مجاز باشند.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "نحوه استفاده از Omnichat را کشف کنید و از انجمن پشتیبانی بگیرید.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "",
  Docling,
  "Docling Parameters": "",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "ساخته شده توسط OpenWebUI Community",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "پشتیبانی MCP آزمایشی است و مشخصات آن اغلب تغییر می‌کند، که می‌تواند منجر به ناسازگاری شود. پشتیبانی از مشخصات OpenAPI مستقیماً توسط تیم Omnichat نگهداری می‌شود و آن را به گزینه قابل اعتماد‌تری برای سازگاری تبدیل می‌کند.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat می‌تواند از ابزارهای ارائه شده توسط هر سرور OpenAPI استفاده کند.",
  "Omnichat uses faster-whisper internally.": "Omnichat به صورت داخلی از faster-whisper استفاده می‌کند.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat از SpeechT5 و جاسازی‌های گوینده CMU Arctic استفاده می‌کند.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "نسخه Omnichat (v{{OPEN_WEBUI_VERSION}}) پایین‌تر از نسخه مورد نیاز (v{{REQUIRED_VERSION}}) است",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "در حال هدایت به OpenWebUI Community",
  ...
  "Share to Omnichat Community": "اشتراک گذاری با OpenWebUI Community",
