...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "Omnichat soʻrovlariga ruxsat berish uchun CORS provayder tomonidan toʻgʻri sozlangan boʻlishi kerak.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Omnichat-dan qanday foydalanishni bilib oling va hamjamiyatdan yordam so'rang.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Omnichat hamjamiyati tomonidan yaratilgan",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat har qanday OpenAPI serveri tomonidan taqdim etilgan vositalardan foydalanishi mumkin.",
  "Omnichat uses faster-whisper internally.": "Omnichat ichki tez shivirlashdan foydalanadi.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat SpeechT5 va CMU Arctic dinamik oʻrnatishlaridan foydalanadi.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Ochiq WebUI versiyasi (v{{OPEN_WEBUI_VERSION}}) talab qilingan versiyadan (v{{REQUIRED_VERSION}}) pastroq",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Sizni Omnichat hamjamiyatiga yoʻnaltirmoqda",
  ...
  "Share to Omnichat Community": "Omnichat hamjamiyatiga ulashing",
