...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS musí být správně nakonfigurován poskytovatelem, aby povolil požadavky z Omnichat.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Zjistěte, jak používat Omnichat, a vyhledejte podporu od komunity.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Vytvořeno komunitou Omnichat",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat může používat nástroje poskytované jakýmkoli serverem OpenAPI.",
  "Omnichat uses faster-whisper internally.": "Omnichat interně používá faster-whisper.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat používá SpeechT5 a vektorizaci mluvčích CMU Arctic.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Verze Omnichat (v{{OPEN_WEBUI_VERSION}}) je nižší než požadovaná verze (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Přesměrovávám vás do komunity Omnichat",
  ...
  "Share to Omnichat Community": "Sdílet s komunitou Omnichat",
