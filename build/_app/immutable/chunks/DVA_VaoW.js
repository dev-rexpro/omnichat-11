...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS täytyy olla konfiguroitu palveluntarjoajan toimesta pyyntöjen hyväksymiseksi Omnichat:sta.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Tutustu Omnichat:n käyttöön ja pyydä tukea yhteisöltä.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Haluatko jakaa käyttötilastosi Omnichat yhteisön kanssa?",
  Docling,
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Tehnyt OpenWebUI-yhteisö",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "MCP-tuki on kokeellinen ja sen määritykset muuttuvat usein, mikä voi johtaa yhteensopivuus ongelmiin. OpenAPI-määritysten tuesta vastaa suoraan Omnichat -tiimi, joten se on luotettavampi vaihtoehto yhteensopivuuden kannalta.",
  Medium,
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat voi käyttää minkä tahansa OpenAPI-palvelimen tarjoamia työkaluja.",
  "Omnichat uses faster-whisper internally.": "Omnichat käyttää faster-whisperia sisäisesti.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat käyttää SpeechT5:tä ja CMU Arctic -kaiuttimen upotuksia.",
  "Omnichat version": "Omnichat versio",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Omnichat -versio (v{{OPEN_WEBUI_VERSION}}) on alempi kuin vaadittu versio (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Omnichat. Your privacy is paramount: no message content is ever shared.": "Osallistu yhteisön tulostaulukoihin ja arviointeihin! Koottujen käyttötilastojen synkronointi auttaa edistämään Omnichat:n tutkimuksia ja parannuksia. Tietosuojasi on ensiarvoisen tärkeää: viestien sisältöä ei koskaan jaeta.",
  Password,
  ...
  "Redirecting you to Omnichat Community": "Ohjataan sinut OpenWebUI-yhteisöön",
  ...
  "Share to Omnichat Community": "Jaa OpenWebUI-yhteisöön",
