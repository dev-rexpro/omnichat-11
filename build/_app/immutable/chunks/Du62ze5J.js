...
const translation = {
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Sukurta OpenWebUI bendruomenės",
  ...
  "Omnichat uses faster-whisper internally.": "",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Tortue Chat versija per sena. Reikalinga (v{{REQUIRED_VERSION}}) versija.",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Perkeliam Jus į OpenWebUI bendruomenę",
  ...
  "Share to Omnichat Community": "Dalintis su OpenWebUI bendruomene",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "Jūsų finansinis prisidėjimas tiesiogiai keliaus modulio kūrėjui.",
