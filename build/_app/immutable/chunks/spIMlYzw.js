import "./DKem_M_z.js";
import "./DwLkIEu4.js";
import { bd as delegate, p as push, c as child, t as template_effect, l as get, a as append, n as sibling, r as reset, be as delegated, q as event, k as set, b as pop, b3 as state, A as user_derived, i as first_child, h as comment, d as set_text, f as from_html, F as from_svg, a$ as to_array, D as text, g as getContext, x as deep_read_state, z as untrack, s as setup_stores, e as store_get, w as legacy_pre_effect, y as legacy_pre_effect_reset, m as mutable_source, u as derived_safe_equal, o as onMount, aW as mutate } from "./CISwU846.js";
import { i as if_block } from "./Cr87xL-z.js";
import { i as init } from "./CDjUy0iz.js";
import { g as goto } from "./A3V7pFI8.js";
import { c as config, a as models, u as user } from "./C2d9K3Bp.js";
import { e as each, i as index } from "./D16NL_tt.js";
import { a as set_attribute, s as set_class, c as clsx, d as set_style, f as bind_select_value } from "./CpNYkTX2.js";
...
import { F as formatNumber } from "./7pK2BKln.js";
      ...
      each(node_4, 3, chatList, (chat) => chat.id, ($$anchor3, chat, idx) => {
        ...
        var node_6 = child(div_9);
        {
          var consequent_5 = ($$anchor4) => {
            ...
            reset(div_10);
            template_effect(() => {
              set_attribute(img, "src", `${WEBUI_API_BASE_URL ?? ""}/users/${(get(chat), untrack(() => get(chat).user_id)) ?? ""}/profile/image`);
      ...
      each(node_21, 3, () => get(sortedModels), (model) => model.model_id, ($$anchor3, model, idx) => {
        ...
        template_effect(
          ($0, $1, $2) => {
            ...
            set_attribute(img, "src", `${WEBUI_API_BASE_URL ?? ""}/models/model/profile/image?id=${(get(model), untrack(() => get(model).model_id)) ?? ""}`);
      ...
      each(node_32, 3, () => get(sortedUsers), (user2) => user2.user_id, ($$anchor3, user2, idx) => {
        ...
        template_effect(
          ($0, $1, $2) => {
            ...
            set_attribute(img_1, "src", `${WEBUI_API_BASE_URL ?? ""}/users/${(get(user2), untrack(() => get(user2).user_id)) ?? ""}/profile/image`);
