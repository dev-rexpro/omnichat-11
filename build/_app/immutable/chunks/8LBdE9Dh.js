...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS muss vom Anbieter korrekt konfiguriert sein, um Anfragen von Omnichat zuzulassen.",
  ...
  "Discover how to use Omnichat and seek support from the community.": "Entdecken Sie Omnichat und finden Sie Unterstützung in der Community.",
  ...
  "Do you want to sync your usage stats with Omnichat Community?": "Möchten Sie Ihre Nutzungsstatistiken mit der Omnichat Community synchronisieren?",
  Docling,
  ...
  Inactive,
  Include,
  "Include `--api-auth` flag when running stable-diffusion-webui": "Fügen Sie beim Ausführen von stable-diffusion-webui das Flag `--api-auth` hinzu",
  "Include `--api` flag when running stable-diffusion-webui": "Fügen Sie beim Ausführen von stable-diffusion-webui das Flag `--api` hinzu",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Von der Omnichat Community",
  ...
  MBR,
  MCP,
  "MCP support is experimental and its specification changes often, which can lead to incompatibilities. OpenAPI specification support is directly maintained by the Omnichat team, making it the more reliable option for compatibility.": "Die MCP-Unterstützung ist experimentell und ihre Spezifikation ändert sich häufig, was zu Inkompatibilitäten führen kann. Die Unterstützung der OpenAPI-Spezifikation wird direkt vom Omnichat-Team gepflegt und ist daher die verlässlichere Option.",
  Medium,
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.": "Ups! Sie verwenden eine nicht unterstützte Methode (nur Frontend). Bitte stellen Sie die WebUI über das Backend bereit.",
  ...
  "Omnichat can use tools provided by any OpenAPI server.": "Omnichat kann Werkzeuge verwenden, die von jedem OpenAPI-Server bereitgestellt werden.",
  "Omnichat uses faster-whisper internally.": "Omnichat verwendet intern faster-whisper.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat verwendet SpeechT5 und CMU Arctic Speaker-Embeddings.",
  "Omnichat version": "Omnichat Version",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Die installierte Open-WebUI-Version (v{{OPEN_WEBUI_VERSION}}) ist niedriger als die erforderliche Version (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Participate in community leaderboards and evaluations! Syncing aggregated usage stats helps drive research and improvements to Omnichat. Your privacy is paramount: no message content is ever shared.": "Nehmen Sie an Community-Bestenlisten und Evaluationen teil! Das Synchronisieren aggregierter Nutzungsstatistiken hilft dabei, die Forschung und Verbesserungen von Omnichat voranzutreiben. Ihre Privatsphäre steht an erster Stelle: Es werden niemals Nachrichteninhalte geteilt.",
  Password,
  ...
  "Redirecting you to Omnichat Community": "Sie werden zur Omnichat Community weitergeleitet",
  ...
  "Share to Omnichat Community": "Mit der Omnichat Community teilen",
  ...
  "To access the WebUI, please reach out to the administrator. Admins can manage user statuses from the Admin Panel.": "Für Zugriff auf die WebUI wenden Sie sich bitte an den Administrator. Administratoren können den Benutzerstatus im Admin-Panel verwalten.",
