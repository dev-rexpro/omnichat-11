...
var _modified;
import { splitAccessPath, stringValue as $, mergeConfig, isObject, hasOwnProperty as has, isNumber, isString, writeConfig, logger, Warn, isArray, array, parseSelector as eventSelector, isBoolean as isBoolean$1, identity, parseExpression as parser, isFunction } from "./BObXj0r9.js";
var version$1 = "6.4.2";
var pkg = {
  version: version$1
};
...
function addLineBreaksToTooltip(channelDef, config, expr = "datum") {
  if (isFieldDef(channelDef) && isDiscrete$1(channelDef.type) && !getFormatMixins(channelDef).format && !getFormatMixins(channelDef).formatType) {
