...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS має бути правильно налаштований постачальником, щоб дозволити запити з Omnichat.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Дізнайтесь, як використовувати Omnichat, та звертайтесь за підтримкою до спільноти.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Зроблено спільнотою OpenWebUI",
  ...
  "Omnichat uses faster-whisper internally.": "Omnichat використовує faster-whisper внутрішньо.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat використовує вбудовування голосів SpeechT5 та CMU Arctic.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Omnichat версія (v{{OPEN_WEBUI_VERSION}}) нижча за необхідну версію (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  "Redirecting you to Omnichat Community": "Перенаправляємо вас до спільноти OpenWebUI",
  ...
  "Share to Omnichat Community": "Поділитися зі спільнотою OpenWebUI",
