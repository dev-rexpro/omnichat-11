...
const translation = {
  ...
  "CORS must be properly configured by the provider to allow requests from Omnichat.": "CORS phải được cấu hình đúng bởi nhà cung cấp để cho phép các yêu cầu từ Omnichat.",
  "Could not read file.": "",
  CPU,
  Create,
  ...
  "Discover how to use Omnichat and seek support from the community.": "Khám phá cách sử dụng Omnichat và tìm kiếm sự hỗ trợ từ cộng đồng.",
  ...
  Low,
  LTR,
  "Made by Omnichat Community": "Được tạo bởi Cộng đồng OpenWebUI",
  ...
  "Omnichat uses faster-whisper internally.": "Omnichat sử dụng faster-whisper bên trong.",
  "Omnichat uses SpeechT5 and CMU Arctic speaker embeddings.": "Omnichat sử dụng SpeechT5 và các embedding giọng nói CMU Arctic.",
  "Omnichat version": "",
  "Omnichat version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "Phiên bản Omnichat (v{{OPEN_WEBUI_VERSION}}) hiện thấp hơn phiên bản bắt buộc (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  Record,
  "Record voice": "Ghi âm",
  "Redirecting you to Omnichat Community": "Đang chuyển hướng bạn đến Cộng đồng OpenWebUI",
  ...
  "Share to Omnichat Community": "Chia sẻ đến Cộng đồng OpenWebUI",
  ...
  "Your entire contribution will go directly to the plugin developer; Omnichat does not take any percentage. However, the chosen funding platform might have its own fees.": "Toàn bộ đóng góp của bạn sẽ được chuyển trực tiếp đến nhà phát triển plugin; Omnichat không lấy bất kỳ tỷ lệ phần trăm nào. Tuy nhiên, nền tảng được chọn tài trợ có thể có phí riêng.",
