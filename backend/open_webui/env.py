...
# Useful when Omnichat sits behind a reverse proxy / API gateway that
...
# compatible APIs for endpoints not natively handled by Omnichat.
...
WEBUI_NAME = os.getenv('WEBUI_NAME', 'Omnichat')
if WEBUI_NAME != 'Omnichat':
    WEBUI_NAME += ' (Omnichat)'

WEBUI_FAVICON_URL = 'https://omnichat.rexpro.com/favicon.png'
