...
# can't be a legitimate Omnichat collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current Omnichat naming conventions for
        collection names. If Omnichat changes how it generates collection names
