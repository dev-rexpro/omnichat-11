...
"""
    try:
        ...
        print(f'Omnichat v{VERSION} - building the best AI user interface.\nhttps://github.com/open-webui/open-webui')
...
async def generate_messages(
    ...
    All models configured in Omnichat are accessible via this endpoint.
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for Omnichat.
